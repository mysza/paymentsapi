...
func (_m *PaymentsRepository) Delete(_a0 *uuid.UUID) error {
	ret := _m.Called(_a0)
...
func (_m *PaymentsRepository) Exists(_a0 *uuid.UUID) bool {
	ret := _m.Called(_a0)
...
func (_m *PaymentsRepository) Get(_a0 *uuid.UUID) (*domain.Payment, error) {
	ret := _m.Called(_a0)

	var r0 *domain.Payment
	if rf, ok := ret.Get(0).(func(*uuid.UUID) *domain.Payment); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
